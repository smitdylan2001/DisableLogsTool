...
//FROM: https://docs.unity3d.com/ScriptReference/Logger-filterLogType.html
//TRY: https://docs.unity3d.com/ScriptReference/ILogger.html
...
public class DisableLogsTool : MonoBehaviour
{
    ...
    [Tooltip("Max allowed log type being used in the Unity Editor. Unity will only log the type(s) selected and those below it!")]
    ...
    [Tooltip("Max allowed log type being used in builds. Unity will only log the type(s) selected and those below it!")]
	...
	///enable all logs
	///</summary>
	/// <param name="onlyInBuild">If set to true, logs will only be enabled in builds, not in the Unity Editor</param>
	...
	///Disable all logs
	///</summary>
	/// <param name="onlyInBuild">If set to true, logs will only be disabled in builds, not in the Unity Editor</param>
